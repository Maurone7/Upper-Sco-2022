...
from data_file import flux_barenfeld_0_88mm_updated, flux_list_2_87mm_garrett
...
for index, element in enumerate(flux_list_2_87mm_garrett):
    spectral_index_upper_sco.append(spectra_index(flux_list_2_87mm_garrett[index], flux_barenfeld_0_88mm_updated[index], 10 ** 10 / 0.287, 10 ** 10 / 0.087))
