...
for wavelengths in wavelength_list:
    ...
    for inclinations in i_list:
        ...
        # define integration
            ...
            x_axis_values.append(sur_den(R))
            AU += steps
        ...
        plt.plot(x_axis_values, y_axis_values, label=('$\lambda = $' + str(wavelength) + " cm " + str(inclinations) + ' degrees'), linestyle=linestyle, color=color)
        y_axis_values = []
        x_axis_values = []
